...
import DocumentUploadDialog from '../UserDocumentUploadDialog'
...
export default function UserDocumentList({
  ...
  const saveDoc = async (form: UserDocumentFormState) => {
  ...
  const uploadDoc = async (form: UserDocumentFormState) => {
    setLoading(true)
