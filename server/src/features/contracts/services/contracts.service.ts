...
import { TimeSlot } from 'src/core/models/TimeSlot'
import { Contract } from '../entities/Contract.entity'
import { UsersService } from 'src/features/users/services/users.service'
import { SubjectsService } from 'src/features/subjects/services/subjects.service'
...
import { parseTimeSlot } from 'src/core/utils/TimeSlotUtils'
...
export class ContractsService {
  ...
  async suggestContracts(dto: SuggestTimeSlotsDto): Promise<any[]> {
    let customers = []
