...
import { ContractsService } from 'src/features/contracts/services/contracts.service'
...
import { ClassCustomer } from 'src/features/users/entities/classCustomer.entity'
import { PrivateCustomer } from 'src/features/users/entities/privateCustomer.entity'
import ContractType from 'src/core/enums/ContractType.enum'
import LeaveState from 'src/core/enums/LeaveState.enum'
import { Leave } from 'src/features/users/entities/Leave'
import { formatInvoiceNumber } from 'src/core/utils/FormatInvoiceNumber'
import { getLessonDates } from '../utils/GetLessonDates'
...
export class LessonsService {
  ...
  async generateInvoiceTeacher({
    ...
    lessons.forEach((lesson) => {
      ...
      if (customers[0].role === UserRole.CLASSCUSTOMER) {
    ...
    const filePath = path.join(__dirname, '../../../core/templates/teacherList.ejs')
  ...
  async generateInvoice({
    ...
    if (customer.role === UserRole.SCHOOL) {
    ...
    const filePath = path.join(__dirname, '../../../core/templates/customerInvoice.ejs')
