export const passwordResetMail = (link:string) => {
  return `Liebes Schülertreff-Mitglied,\n\n
...
export const applicationMeetingProposalMail = (name: string, link: string, formattedDates: string[]) => {
  ...
  ${formattedDates.reduce((prevVal, currentVal) => prevVal + "\n" + currentVal)}\n
...
export const applicationMeetingSetDateMail = (name: string, link: string, formattedDate: string) => {
  return `Sehr geehrte/r ${name},\n\n
